...
The TypeScript SDK handles many of the low-level details, for example, it will forge the transaction to create a new entity and handle all the different aspects of it.  
The SDK is self-understandable, and there seem to be very few quirks to learn that are inherent in learning a new tooling suite.
...
The only issues I had were not due to the SDK, but to other elements in the ecosystem.  
First, I was unable to obtain test tokens from the faucet and left a message in the Discord channel. The tokens were transferred to my account, although the faucet displayed an error message.  
